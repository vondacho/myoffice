...
@Slf4j
public class SaleEventBrokerFluxSinkRegistrar {

    private SaleEventBrokerFluxSinkRegistrar() {
    }
    ...
    public static void register(FluxSink<SaleEvent> fluxSink,
        ...
        broker.subscribe(subscriberId, new SaleEventBrokerFluxSinkSubscriber(subscriberId, processor, fluxSink));
